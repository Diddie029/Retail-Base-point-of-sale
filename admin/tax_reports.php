...
if (!hasPermission('view_tax_reports', $permissions)) {
...
<head>
    ...
    <style>
        ...
        /* Default Category Styling for List View */
        .default-category-row {
            background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%);
            border-left: 4px solid #f59e0b;
        }

        .default-category-row .category-name {
            color: #92400e;
        }

        .default-category-row .badge {
...
<body>
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <!-- Tax Collection by Category - List View -->
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title mb-0">
                                    <i class="bi bi-list-ul me-2"></i>Tax Collection by Category
                                </h5>
                                ...
                                <table class="table table-hover mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="border-0">Tax Rates</th>
                                            <th class="border-0 text-end">Tax Collected</th>
                                            <th class="border-0 text-end">Taxable Amount</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="category-item <?php echo isset($data['is_default']) && $data['is_default'] ? 'default-category-row' : ''; ?>" 
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex align-items-center">
                                                    <div class="category-color-indicator me-3" 
                                                         style="width: 4px; height: 40px; background-color: <?php echo $colors[$color_index % count($colors)]; ?>; border-radius: 2px;"></div>
                                                    <div>
                                                        ...
                                                        <small class="text-muted">
                                                            ...
                                                            Default tax category from admin settings
                                                        </small>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="align-middle text-end">
                                                <span class="fw-bold text-primary">
                                                    <?php echo $settings['currency_symbol']; ?><?php echo number_format($data['total_tax'], 2); ?>
                                                </span>
                                            </td>
                                            <td class="align-middle text-end">
                                                <span class="fw-semibold">
                                                    <?php echo $settings['currency_symbol']; ?><?php echo number_format($data['total_taxable'], 2); ?>
                                                </span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="badge bg-secondary">
                                                    <?php echo number_format($data['sale_count']); ?>
                                                </span>
                                            </td>
                                            <td class="align-middle text-end">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function sortCategories(sortBy) {
                ...
                // Re-append sorted items to tbody
