        ...
        <main class="content">
            <div class="container-fluid">
                ...
                <div class="coming-soon">
                    ...
                    <h3>Coming Soon</h3>
                    <p class="text-muted">This inventory reports module is currently under development. It will include:</p>
                    <ul class="list-unstyled">
                        <li><i class="bi bi-check-circle text-success"></i> Stock Level Reports</li>
                        <li><i class="bi bi-check-circle text-success"></i> Inventory Turnover Analysis</li>
                        <li><i class="bi bi-check-circle text-success"></i> Low Stock Alerts</li>
                        <li><i class="bi bi-check-circle text-success"></i> Inventory Valuation</li>
                        <li><i class="bi bi-check-circle text-success"></i> Supplier Performance</li>
                    </ul>
