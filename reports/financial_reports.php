        ...
        <main class="content">
            <div class="container-fluid">
                ...
                <div class="coming-soon">
                    ...
                    <h3>Coming Soon</h3>
                    <p class="text-muted">This financial reports module is currently under development. It will include:</p>
                    <ul class="list-unstyled">
                        <li><i class="bi bi-check-circle text-success"></i> Profit & Loss Statements</li>
                        <li><i class="bi bi-check-circle text-success"></i> Balance Sheet Reports</li>
                        <li><i class="bi bi-check-circle text-success"></i> Cash Flow Analysis</li>
                        <li><i class="bi bi-check-circle text-success"></i> Financial Forecasting</li>
                        <li><i class="bi bi-check-circle text-success"></i> ROI and Performance Metrics</li>
                    </ul>
                    <a href="../finance/index.php" class="btn btn-primary">
