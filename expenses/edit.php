...
// Check permissions
if (!hasPermission('edit_expenses', $permissions)) {
...
// Get expense details
$stmt = $conn->prepare("SELECT * FROM expenses WHERE id = :expense_id");
...
if ($expense['approval_status'] !== 'pending') {
    $_SESSION['error_message'] = "This expense cannot be edited as it has already been approved or rejected.";
    ...
    if (empty($errors)) {
        try {
            ...
            if (isset($_FILES['receipt']) && $_FILES['receipt']['error'] == 0) {
                ...
                $file_name = $expense['expense_number'] . '_' . time() . '.' . $file_extension;
            ...
            // Log activity
            logActivity($conn, $user_id, 'expense_updated', "Updated expense: {$expense['expense_number']} - $title");

            $_SESSION['success_message'] = "Expense updated successfully! Expense Number: {$expense['expense_number']}";
            header('Location: view.php?id=' . $expense_id);
            exit();
...
<head>
    ...
    <title>Edit Expense - <?php echo htmlspecialchars($settings['company_name'] ?? 'POS System'); ?></title>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-pencil-square"></i> Edit Expense - <?= htmlspecialchars($expense['expense_number']) ?></h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="title" value="<?= htmlspecialchars($expense['title']) ?>" required maxlength="200">
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" rows="3" maxlength="500"><?= htmlspecialchars($expense['description']) ?></textarea>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" name="amount" id="amount" step="0.01" min="0" value="<?= $expense['amount'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">KES</span>
                                                <input type="number" class="form-control" name="tax_amount" id="tax_amount" step="0.01" min="0" value="<?= $expense['tax_amount'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-body">
                                            <textarea class="form-control" name="notes" rows="4" placeholder="Additional notes..." maxlength="500"><?= htmlspecialchars($expense['notes']) ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
