        ...
        foreach ($cart_items as $item) {
            ...
            if (isset($item['is_auto_bom']) && $item['is_auto_bom']) {
                ...
                $sale_items[] = [
                    ...
                    'total_price' => $item_total,
                    'is_auto_bom' => false,
                    'base_quantity_deducted' => $item['quantity']
                ];
            }
        }
                            ...
                            if (isset($item['is_auto_bom']) && $item['is_auto_bom']) {
                                try {
                                    ...
                                    if (!$inventory_check['available']) {
                                        ...
                                        $inventory_warnings[] = "Insufficient stock for " . htmlspecialchars($item['name']);
                                    }
                                } catch (Exception $e) {
                                    $has_inventory_warnings = true;
                                    $inventory_warnings[] = "Error checking inventory for " . htmlspecialchars($item['name']);
                                }
                            }
                        ?>
                    ...
                    <form method="POST" id="checkoutForm">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-success btn-lg"
                                    <?php echo $has_inventory_warnings ? 'disabled' : ''; ?>>
